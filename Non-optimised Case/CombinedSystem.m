...
%  the five fridge plants accordin
% g to Eskom's
%  time-of-day tariffs.
...
% plot(t/86400, u.F_Ice(t), t/86400, u.F_Ice_generated(t));
% ax = gca;
% ax.FontSize = p.font_size;
% legend('measured', 'AR model')
% ylabel('F_I_c_e (L/S)'); xlabel('Time (days)');
...
%p.loop       = 2:1:359;                    % ~, Simulation points for the loop in minutes (mostly for testing)
